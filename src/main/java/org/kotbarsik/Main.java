...
//           System.out.println(startMoex);
    ...
    public static double calculatePercent(int startYear, double moex, int expenses, int index) {
        double percent = 0;
